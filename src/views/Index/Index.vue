        ...
        <div class="index_swiper wow animate__animated animate__fadeIn">
            <el-carousel :interval="3000" :autoplay="false" arrow="always">
                <el-carousel-item v-for="(item,index) in swiperList" :key="index">
                    ...
                    <img style="width:100%;height:700px;object-fit: cover;" class="carousel_item_img" :src="item.image.fileUrl" alt="" @click="goOtherPath(item)">
                    <!-- <img v-if="item.image" style="width:0;height:0;" :src="item.image.fileUrl" alt="" @load="bannerImgLoading"> -->
        ...
        <div class="edu_content">
            ...
            <div class="team_in resourse_in wow animate__animated animate__fadeInUp" data-wow-delay=".5s">
                <div class="title wow animate__animated animate__fadeInDown" data-wow-delay=".8s">
                    <div class="english">CENTER RESOURCES</div>
                    <div class="chinese">中心资源</div>
                </div>
                <div class="team_content">
                    
                        <div class="resourse_card"  v-for="(item, index) in resourse_info" :key="index">
                            <div class="card_title" v-for="(t_item, t_index) in item.title" :key="t_index">{{t_item }}</div>
                            <div class="card_info" v-for="(i_item, i_index) in item.info" :key="i_index">{{i_item }}</div>
                        </div>
                    ...
                    <!-- <div class="team_section" @mouseenter="onMouseEnter(1)" @mouseleave="onMouseLeave(1)">
                        ...
                        <swiper :options="swiperOptionResourse" ref="mySwiperResourse" 
                        >
                            <swiper-slide
                                class="swiper-slide"
                        ...
                        <div class="center_section">
                            <div class="center_section_left wow animate__animated animate__fadeInLeft" data-wow-delay=".8s">
                                <div class="center_section_left_top">
                                    <div class="center_section_left_top_view"
                                    @mouseenter="handleMouseEnter(1,'left')" @mouseleave="handleMouseLeave(1,'left')"
                                    @click="goCenter()"
                                    >
                                ...
                                <div class="center_section_left_img">
                                    <img   src="../../assets/images/cen/center_about1.jpg" alt="">
                                </div>
                            ...
                            <div class="center_section_right wow animate__animated animate__fadeInRight" data-wow-delay=".8s"
                                ...
                                <!-- <img class="center_section_right_img" :style="centerRightStyle" src="../../assets/images/cen/center_about2.png" alt=""> -->
                            </div>
                        </div>
                    </div>
            ...
            <div class="team_in science_in partner_in wow animate__animated animate__fadeInUp" data-wow-delay=".5s">
                <div class="title wow animate__animated animate__fadeInDown" data-wow-delay=".8s">
                    <div class="english">NEWS TRENDS</div>
                    <div class="chinese">新闻动态</div>
                </div>
                <div class="team_content">
                    <div class="team_section science_section">
                        ...
                        >
                            <swiper-slide
                                ...
                                :key="item.id"
                            >
                                <div class="swiper-slide_boxs" @click="goEduDetail(item)">
                                    <div class="team_item_image">
                                        <img v-if="item.image" :src="item.image.fileName=='关注.jpg'?newsDefaultImg:url+item.image.fileUrl" />
                                    </div>
                                    <div class="team_item_text">
                                        <div class="team_item_text_top" v-if="item.hot">
                                            <div class="team_item_text_top_hot">
                                                <div class="team_item_text_top_hot_text">
                                                    <img src="../../assets/images/hot.png" alt="" srcset="">
                                                    热点新闻
                                                </div>
                                            </div>
                                            <div class="team_item_text_top_title">
                                                <el-tooltip :content="item.title" placement="bottom" effect="light">
                                                    <span>{{item.title}}</span>
                                                </el-tooltip>
                                            </div>
                                        </div>
                                        <div class="team_item_text_top" v-else>
                                            <div class="team_item_text_top_title_all">
                                                <el-tooltip :content="item.title" placement="bottom" effect="light">
                                                    <span>{{item.title}}</span>
                                                </el-tooltip>
                                            </div>
            ...
            <!-- 科普活动 -->
            <div class="team_in news_in wow animate__animated animate__fadeInUp" v-if="false" data-wow-delay=".5s">
                <div class="title wow animate__animated animate__fadeInDown" data-wow-delay=".8s">
                    ...
                    <div class="news_section">
                        <div class="news_section_left wow animate__animated animate__fadeInLeft" @click="goNewsDetail(newsDetail)" data-wow-delay="1s">
                            ...
                            <div class="news_section_left_bottom">
                                <div class="team_item_text_top" v-if="newsDetail.hot">
                                    <div class="team_item_text_top_hot">
                                        <div class="team_item_text_top_hot_text">
                                            <img src="../../assets/images/hot.png" alt="" srcset="">
                                        </div>
            ...
            <!-- 合作伙伴 -->
            <!-- v-if="partner.data&&partner.data.records.length" -->
            <div class="team_in partner_in wow animate__animated animate__fadeInUp" v-if="false" data-wow-delay=".5s">
                <div class="title wow animate__animated animate__fadeInDown" data-wow-delay=".8s">
...
export default {
    ...
    data() {
        return {
            ...
            newsDefaultImg:require('../../assets/images/cen/news_bg.jpg'),
            newsDetail:{},
        ...
        async getOnlineConsultationPage() {
            ...
            if(res.code==1) {
                if(res.data.records.length>0) {
                    ...
                    this.suspension = [...this.suspensionOne]
                }
            }
        },
        onMouseEnterScience() {
    ...
    mounted() {
        this.swiperList = [
                {image:{
                    fileUrl: require('../../assets/images/index/home_img.jpg')
                }},
                {image:{
                    fileUrl:require('../../assets/images/index/home_img2.jpg')
                }}
        ...
        .center_in {
            ...
            .title {
                ...
                .english {
                    ...
                    background: -webkit-linear-gradient(0deg,#333333, #989898); /* Chrome, Safari */
                    background: linear-gradient(0deg, #333333, #989898); /* 标准语法 */
            ...
            .team_content{
                ...
                .resourse_card{
                    ...
                    .card_title{
                        ...
                        margin-top: 0.1rem;
                        // color: #0043ce;
                        background: -webkit-linear-gradient(0deg,#AE2129, #ff8282); /* Chrome, Safari */
                        background: linear-gradient(0deg, #AE2129, #ff8282); /* 标准语法 */
                        -webkit-background-clip: text; /* Chrome, Safari */
                        background-clip: text;
                        -webkit-text-fill-color: transparent; /* Chrome, Safari */
                        color: transparent; /* 兼容不支持background-clip的浏览器 */
                ...
                .resourse_card:nth-of-type(3){
                    .card_info:nth-of-type(3)::before ,.card_info:nth-of-type(5)::before{
                        display: none;
                    }
                }
            }
